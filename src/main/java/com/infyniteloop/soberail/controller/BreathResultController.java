...
public class BreathResultController {
     ...
     */
    @GetMapping("/all")
    public BreathResultResponseDto getAllBARecords(@RequestParam(defaultValue = "0") @Min(value = 0, message = "Page number must be greater than or equal to 0") Integer pageNo,
    ...
    public BreathResultResponseDto getBARecordsByTesterId(@PathVariable @ValidUUID UUID id, @RequestParam(defaultValue = "0") @Min(value = 0, message = "Page number must be greater than or equal to 0") Integer pageNo,
                                                          @RequestParam(defaultValue = "10") @Min(value = 1, message = "Page size must be greater than or equal to 1")
